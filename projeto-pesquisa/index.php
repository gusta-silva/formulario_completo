...
<div class="container">  
  ...
  <form name="form1" style="background-color: white" id="contact" action="index.php" method="post">
    
 <br><img src="static/img/logo.jpg" class="imagemcont" height="36%" width="100%"></br>

    <br><h3>Identificação funcional</h3><hr></br>
    
    <fieldset>
     <input placeholder="Seu nome completo" name="nome" type="text" tabindex="1" required="nome">
    </fieldset>
 <fieldset>
      <input placeholder="Endereço e número da residência" name="endereco" type= "text" tabindex="4" maxlength="100" required>
    </fieldset>

     <fieldset>
      <input placeholder="Bairro" name="bairro" type= "text" tabindex="4" maxlength="100" required>
    </fieldset>

     <fieldset><input type="text" placeholder="Data de nascimento: dia/mês/ano" name="data" id="datanascimento" maxlength="10" onkeypress="mascaraData( this, event )"></fieldset>


     <fieldset>
      <input placeholder="telefone" name="telefone" type= "text" tabindex="4" maxlength="110" required>
    </fieldset>

     <fieldset>
      <input placeholder="Email" name="email" type= "text" tabindex="4" maxlength="110" required>
    </fieldset>

    
<!--
    <fieldset>
                <input placeholder="Lotação (Ex.:GEP)" type="text" name="lotacao" tabindex="2" required="lotacao" required list="iLotacao">
    ...
    <fieldset>
      <input placeholder="Matrícula (Número da matrícula)" name="matricula" type= "text" tabindex="4" maxlength="11" required>
    </fieldset>-->

    <fieldset>
      <button name="submit" onclick="return validar()" type="submit" id="contact-submit" data-submit="...Sending">Enviar informações</button>
    </fieldset>  
